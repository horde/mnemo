...
$prefGroups['display'] = [
    ...
    'members' => ['show_notepad', 'sortby', 'sortdir'],
];
...
$prefGroups['sync'] = [
    ...
    'members' => ['sync_notepads', 'activesync_no_multiplex'],
];
